export default function(params) {
  ...
  void main() {
    ...
    vec3 albedo = gb0.yzw;
    vec3 v_position = gb1.yzw;

    //calculate z normal from regular normal
    vec2 compressed_normal = vec2(gb0.x, gb1.x);
    float x_sq = (compressed_normal.x * compressed_normal.x);
    float y_sq = (compressed_normal.y * compressed_normal.y);
    float new_z = sqrt(1.0 - y_sq - x_sq);
    vec3 normal = normalize(vec3(compressed_normal.x, compressed_normal.y, new_z));
