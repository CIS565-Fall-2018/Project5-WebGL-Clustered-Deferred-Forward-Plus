...
import toTextureFrag from '../shaders/gpuBinningToTextureDebug.frag.glsl.js';
import textureDebugFrag from '../shaders/quad.frag.glsl.js';
import TextureBuffer from './textureBuffer';

export const MAX_LIGHTS_PER_CLUSTER = NUM_LIGHTS;
export const NUM_GBUFFERS = 1;

export default class GpuBinningDebugRenderer {
    constructor(xSlices, ySlices, zSlices, camera) {
        ...
        this._progDebug = loadShaderProgram(toTextureVert, textureDebugFrag({
    ...
    render(camera, scene) {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        // Debug, Output the texture
        gl.useProgram(this._progDebug.glShaderProgram);
        const firstGBufferBinding = 4; // You may have to change this if you use other texture slots
        for (let i = 0; i < NUM_GBUFFERS; i++) {
            gl.activeTexture(gl[`TEXTURE${i + firstGBufferBinding}`]);
            gl.bindTexture(gl.TEXTURE_2D, this._gbuffers[i]);
            gl.uniform1i(this._progDebug[`u_gbuffers[${i}]`], i + firstGBufferBinding);
        }
        renderFullscreenQuad(this._progDebug);
        ////////////////////////////////////////////////////////////////////////////////
    }
