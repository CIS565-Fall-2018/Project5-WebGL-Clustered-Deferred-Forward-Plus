...
import toTextureVert from '../shaders/deferredToTexture_opt.vert.glsl';
import toTextureFrag from '../shaders/deferredToTexture_opt.frag.glsl';
import QuadVertSource from '../shaders/quad.vert.glsl';
import fsSource from '../shaders/deferred_opt.frag.glsl.js';
import TextureBuffer from './textureBuffer';
import BaseRenderer from './base';

export const NUM_GBUFFERS = 2;

export default class OptClusterRenderer extends BaseRenderer {
  constructor(xSlices, ySlices, zSlices) {
    ...
    this._progShade = loadShaderProgram(QuadVertSource, fsSource({
      ...
      uniforms: ['u_gbuffers[0]', 'u_gbuffers[1]', 'u_gbuffers[2]', 'u_gbuffers[3]', 'u_viewProjectionMatrix', 'u_viewMatrix', 'u_lightbuffer', 'u_clusterbuffer',
  ...
  render(camera, scene) {
    ...
    gl.uniform1i(this._progShade.u_clusterbuffer, 3);
     // TODO: Bind any other shader inputs      // TODO: Bind any other shader inputs
