...
export default class ClusteredRenderer extends BaseRenderer {
  constructor(xSlices, ySlices, zSlices, tanCalculation, camAspect, zStride) {
    ...
    this._progCopy = loadShaderProgram(toTextureVert, toTextureFrag, {
      uniforms: ['u_viewProjectionMatrix', 'u_viewMatrix', 'u_colmap', 'u_normap', 'u_viewMatrix'],
  ...
  render(camera, scene) {
    ...
    gl.uniform1i(this._progShade.u_xDim, canvas.width);
    gl.uniform1i(this._progShade.u_yDim, canvas.height);
    
    gl.uniformMatrix4fv(this._progShade.u_viewMatrix, false, this._viewMatrix);
    
    gl.uniform1i(this._progShade.u_clusterDimX, this._clusterTexture._elementCount);
    gl.uniform1i(this._progShade.u_clusterDimY, this._clusterTexture._pixelsPerElement);
